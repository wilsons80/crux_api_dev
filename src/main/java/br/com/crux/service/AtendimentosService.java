...
public class AtendimentosService {
	...
	@Autowired
	private GetAtendimentosCmd getCmd;
	@Autowired
	private ExcluirAtendimentosCmd excluirCmd;
	@Autowired
	private AlterarAtendimentosCmd alterarCmd;
	@Autowired
	private CadastrarAtendimentosCmd cadastrarCmd;
