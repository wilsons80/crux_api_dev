...
public class AvaliacoesAlunosService {
	...
	@Autowired
	private GetAvaliacoesAlunosCmd getCmd;
	@Autowired
	private ExcluirAvaliacoesAlunosCmd  excluirCmd;
	@Autowired
	private AlterarAvaliacoesAlunosCmd alterarCmd;
	@Autowired
	private CadastrarAvaliacoesAlunosCmd cadastrarCmd;
