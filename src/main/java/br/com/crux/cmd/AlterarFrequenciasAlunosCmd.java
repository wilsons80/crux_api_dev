...
public class AlterarFrequenciasAlunosCmd {
	...
	public void alterar(FrequenciasAlunosTO to) {
		Optional<FrequenciasAlunos> entityOptional = repository.findById(to.getId());
		if(!entityOptional.isPresent()) {
			throw new NotFoundException("Frequencia do aluno informada não existe.");
		}
		...
		FrequenciasAlunos entity = entityOptional.get();
